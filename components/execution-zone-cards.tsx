...
const resources = [
  {
    ...
    description: "Aqui ficam tutoriais práticos criados conforme demandas reais da operação. Esse banco serve para padronizar processos e acelerar a execução, além de facilitar o onboarding de novos colaboradores dentro da PRO GROWTH GLOBAL.",
    icon: BookOpen,
  ...
  },
  {
    ...
    description: "Repositório dos temas utilizados nos planos da PRO GROWTH GLOBAL: START GROWTH, PRO VÉRTEBRA, SCALE VÉRTEBRA e SCALE GLOBAL. Cada tema segue a estrutura validada de cada plano, garantindo consistência, padrão e replicabilidade das operações.",
    icon: Palette,
