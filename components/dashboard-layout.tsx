...
import { LayoutDashboard, Store, Users, LogOut, Menu, X, ChevronRight, Loader2, Calendar, Rocket, KeyRound, TrendingUp, KanbanSquare, ClipboardList, Megaphone, Gauge, MessageSquareText, Sparkles, HandCoins, BarChart3, FileText, Building2, Filter } from "lucide-react"
...
export function DashboardLayout({ children, userRoles = ["user"] }: DashboardLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Funil", href: "/funil", icon: Filter, roles: ["admin", "comercial", "gestor_ads"] },
