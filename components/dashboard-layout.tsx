...
import { LayoutDashboard, Store, Users, LogOut, Menu, X, ChevronRight, Loader2, Calendar, Rocket, ClipboardList } from "lucide-react"
...
export function DashboardLayout({ children, userRoles = ["user"] }: DashboardLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Demandas", href: "/demandas", icon: ClipboardList, roles: ["admin", "zona_execucao"] },
